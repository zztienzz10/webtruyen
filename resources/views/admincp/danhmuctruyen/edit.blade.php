                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('danhmuc.update',[$danhmuc->id])}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$danhmuc->slug_danhmuc}}" name="slug_danhmuc" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="slug danh mục...">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1"> Mô tả danh mục</label>
                            <input type="text" class="form-control" value="{{$danhmuc->mota}}" name="motadanhmuc" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Mô tả danh mục...">
                        </div>
                        <div class="form-group">
