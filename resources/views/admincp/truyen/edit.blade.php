                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('truyen.update',[$truyen->id])}}" enctype='multipart/form-data' >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$truyen->tentruyen}}" name="tentruyen" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Tên truyện...">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1"> Slug truyện</label>
                            <input type="text" class="form-control" value="{{$truyen->slug_truyen}}" name="slug_truyen" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="slug truyện...">
                        </div>
